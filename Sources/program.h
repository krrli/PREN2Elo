...
enum NewMotorSpeed {
	...
	NEW_MOTOR_BUTTON_SPEED_2 = 20,
	NEW_MOTOR_CURVE_BLIND_SPEED=50,
	NEW_MOTOR_CURVE_SPEED=5
};

#define NEW_MOTOR_CURVE_CORR_VAL 0//10
#define NEW_REAR_MOTOR_OFFSET 15
...
#define NEW_CURVE_BLIND_TIME 300

#define NEW_CURVE_DRIVE_OVER_TIME 250 // value in ms
...
#define PID_BOTH_DIST_P_MULT 20//16
...
#define PID_BOTH_DIFF_P_MULT 20//16
...
#define PID_BOTH_MAX_CORR_VAL 350

#define TOF1_A_OFFSET 6
#define TOF1_B_OFFSET (-6)
